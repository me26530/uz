    ...
    try {
        ...
        for (let i = 0; i < messageList.length; i++) {
            ...
            video.vod_name = video.vod_name
                ...
                .replace(/\s*(杜比视界|杜比音效|WEB-60fpsMAX|WEB-|DV|HDR10|HDR|SDR|臻彩|杜比|高码率|中码率|50帧|25帧|60帧|10bit|10BIT|纯净版|完结|全景声|超高码率|EDR|标码|Vivid|三维菁彩声|txb|源码|剧版|无台标|ATVP|IQ|Friday|多国字幕|双语|简中|日语|无损|特别版|软字幕|补链接|MAX|中码|音效|高码|台配|国语|环绕声|蓝光原盘|臻享超高清)\s*/g, '')
